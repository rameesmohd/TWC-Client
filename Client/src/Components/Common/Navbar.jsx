    ...
    <>
      <Header className="bg-opacity-100 backdrop-blur-lg bg-black/10 border-gray-200 shadow-xl fixed z-50 w-full px-4 py-4 md:py-0">
        <div className="container mx-auto flex flex-wrap items-center justify-between sm:px-14">
          ...
          >
            <ul 
            className="font-medium md:flex flex-col md:flex-row px-4 md:p-0 mt-4 bg-white md:bg-none text-gray-800 md:bg-transparent md:text-white md:mt-0 rounded-lg md:space-x-8 shadow-lg md:shadow-none"
            >
              {options.map((obj, index) => (
                <li key={index}>
                  <Link
                    to={obj.nav}
                    className="block py-1 px-3 text-blue-800 w-full shadow-sm md:shadow-none rounded border-b-white hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0"
                  >
                    {obj.option}
                  </Link>
                </li>
              ...
              {token ? (
                ...
                <>
                  <li className="my-1 ">
                    <Drawer
                      btnText="Login"
                      btnClassname="bg-transparent border-blue-500 border mx-1"
                      Body={<Loginform />}
                    />
                  </li>
                  <li className="my-1">
