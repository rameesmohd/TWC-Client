    ...
    <div className="md:grid grid-cols-2">
      ...
      <div className="hidden md:block col-span-1 bg-blue-gray-100 relative ">
        <img
          ...
          src="https://static.vecteezy.com/system/resources/previews/002/062/410/non_2x/business-candle-stick-graph-chart-of-stock-market-investment-trading-on-white-background-design-bullish-point-trend-of-graph-illustration-vector.jpg"
